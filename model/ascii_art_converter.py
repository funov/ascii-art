class ASCIIArtConverter:
    ...
    def to_ascii_art(grayscale_image, chars):
        ...
        pixels = ASCIIArtConverter.increase_contrast(pixels, len(chars), different_pixels)
        color_to_symbol_dict = ASCIIArtConverter.get_color_to_symbol_dict(chars, different_pixels)
    ...
    def increase_contrast(pixels, color_count, different_pixels):
        ...
        for i in range(len(pixels)):
            ...
            if pixel not in first:
                nearest_pixel = ASCIIArtConverter.round_nearest_number(pixel, first)
